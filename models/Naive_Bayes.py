...
for lemma in lemmas:
    ...
    rows.append({
        ...
        "NB_macroF1": f1_score(y_test, y_pred, average="macro"),
        "NB_precision": precision_score(y_test, y_pred, average="macro", zero_division=0),
        "NB_recall": recall_score(y_test, y_pred, average="macro", zero_division=0)
    })
